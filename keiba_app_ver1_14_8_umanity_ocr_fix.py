...
# ⚙️ アプリ初期設定 & レイアウト
# ==========================================
st.set_page_config(page_title="ジェニーAI予想ver1.14.8", layout="wide")
st.title("🏆 ジェニーAI予想ver1.14.8（スマホ単一画像アップロード版）")
...
def parse_umanity_screenshot_image(uploaded_file, raw_text=""):
    ...
    Ver1.14.8: U指数だけを起点にせず、左端の馬番も行アンカーとして使う。
    ...
    # fallback → 馬番アンカー → U指数アンカーを馬番単位で統合。
...
with tab_img:
    ...
    st.info("📱 Ver1.14.8：馬番アンカー併用で全頭抽出を強化しました。複数枚は順番に処理してください。")
