...
st.title("🏆 ジェニーAI予想ver1.15.2（スマホ単一画像アップロード版）")
...
def parse_umanity_screenshot_image(uploaded_file, raw_text=""):
    ...
    for row_idx in range(8):
        ...
        if u_index is None:
            ...
            if circ:
                try:
                    u_index = float(circ.group(1).replace(",", "."))
                except Exception:
                    u_index = None
...
with tab_img:
    ...
    st.info("📱 Ver1.15.2：ウマニティ画像を1頭ずつ8行に分割し、馬名・U指数を列別OCRする方式に変更しました。複数枚は順番に処理してください。")
