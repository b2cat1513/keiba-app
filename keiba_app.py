...
# === 東京コース ===
    ...
    "中山芝2500m": {"note": "高速馬場の有馬記念は東京中距離G1実績馬◯ 高速馬場は内枠◯ 荒れ馬場は外枠◯ エピファネイア産駒◯ キズナ産駒◯ ドゥラメンテ産駒◯ ゴールドシップ産駒◯ ジャスタウェイ産駒◯"},
    ...
    # === 京都コース ===
    "京都芝1600m(外)": {"note": "同距離&距離短縮馬◯ 高速馬場は上がり時計重視◯ 荒れ馬場は外枠◯ 荒馬場東京で負けたキャラ◯ イスラボニータ産駒◯ ルーラーシップ産駒◯ リオンディーズ産駒◯ キタサンブラック産駒◯ ハービンジャー産駒◯"},
